...
namespace GDPWebApi.Security
{
    ...
    {
        public static User Current { get { return (User)HttpContext.Current.Items[Settings.UserCookieName]; } }

        public static Boolean IsAuthenticated { get { return HttpContext.Current.Items[Settings.UserCookieName] != null; } }
